...
@interface Options : NSObject
{
   ...
   @public NSString *__weak filterKeyword;
   ...
   @public int wpantype;
   @public NSString *__weak wfpeeraddr;
   @public int wfport;
...
@property (readwrite,weak) NSString *filterKeyword;
...
@property (readwrite,weak) NSString *wfpeeraddr;
...
{
    EmulatorController*  __weak emuController;
...
@property (nonatomic, weak) EmulatorController *emuController;
